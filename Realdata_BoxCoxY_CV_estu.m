...
[weightu, betau, lambdahatu] =  get_weight_semiclosed_largeN(T,X,T,X,N,p1u,p2u);
PSu= PS_estv2(X,betau,IS,K2u);
[gTu,gammahatu]=CaliEstPoly_ADRFS(T,T,PSu,weightu,Y,p);

filename=sprintf('Realdata_BoxCox_CV_tc0_estu-%s.mat',datetime('today'));
save(filename)
